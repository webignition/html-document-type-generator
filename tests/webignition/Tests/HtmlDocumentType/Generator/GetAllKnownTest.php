...
class GetAllKnownTest extends BaseTest {        
    ...
    public function testGenerateAll() {
        ...
        $this->assertEquals(array(
            ...
            'xhtml+mobile-11' => '<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.1//EN" "http://www.wapforum.org/DTD/xhtml-mobile11.dtd">',
            'xhtml+mobile-12' => '<!DOCTYPE html PUBLIC "-//WAPFORUM//DTD XHTML Mobile 1.2//EN" "http://www.wapforum.org/DTD/xhtml-mobile12.dtd">',
